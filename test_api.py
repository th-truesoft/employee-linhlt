...
def get_auth_token() -> str:
    ...
    print(
        f"Using {'default' if token == DEFAULT_API_TOKEN else 'custom'} API token for authentication..."
    )
    return token
...
def test_search_api() -> None:
    ...
    status_filter = {"status": ["active"], "page": 1, "page_size": 5}
    ...
    name_filter = {"name": "Nguyen", "page": 1, "page_size": 5}
